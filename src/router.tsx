...
import AttendanceRequiredPage from '@/pages/attendance-required/AttendanceRequiredPage'
...
export const router = createBrowserRouter([
  { path: '/login', element: <LoginPage /> },
  {
    ...
    children: [
      ...
      { path: 'organizations/:id/attendance-required', element: <AttendanceRequiredPage /> },
